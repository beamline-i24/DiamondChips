...
lg.basicConfig(format='%(asctime)s %(levelname)s:   \t%(message)s',level=lg.DEBUG, filename='essex_april18.log')
###############################################
# MANAGER  MANAGER  MANAGER  MANAGER MANAGER  # 
# This version last edited 06Mar2018 by DAS   #
#                                             #
###############################################
...
def write_parameter_file():
    ...
    #visit = '/dls/i24/data/2018/cm19649-1/'
    #visit = '/dls/i24/data/2018/nt14493-94/'
    visit = '/dls/i24/data/2018/nt14493-106/'
...
def cs_maker():
    ...
    scalex, scaley, scalez  = 10011.2, 10002.1, 10000.0
