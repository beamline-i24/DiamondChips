...
from Chip_StartUp_v5 import scrape_parameter_file
from Chip_StartUp_v5 import get_format
...
def main(location='i24'):
    ...
    if location == 'i24':
        ...
        chip_name, visit, sub_dir, n_exposures, chip_type, map_type = scrape_parameter_file(location='SACLA')
    ...
    chip_prog_dict = get_chip_prog_values(chip_type, location, exptime, n_exposures)
