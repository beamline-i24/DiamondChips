...
def make_path_dict():
    ...
    meta_list = [list11, list12, list14, list19, list23, list33, list55, list77, list99]
...
def scrape_dcparameters():
    ...
    print blockcapacity
    print path_key
    return chipname, visit_id, filepath, chipcapacity, blockcapacity, path_key
...
def shotLister_L2RWs_TypewriterRows(fid):
    ...
    spec_fid = fid[:-4] + 'spec'
    print spec_fid
    save_file(tmp_spec_fid, spec_fid)
    return 0
...
def main():
    ...
    line7 = '#&SACLA\tpath_key = %s\n'  %path_key
    line8 = '#\n'    
    line9 = '#XtalAddr      XCoord  YCoord  ZCoord  Present Shot  Spare04 Spare03 Spare02 Spare01\n'    
    g.write(line1)
    g.write(line2)
    g.write(line3)
    g.write(line4)
    ...
    for road in road_list:
        for cross in cross_list:
            ...
            for r2 in block_row_list:
                ...
                #print
    g.close() 
    shotLister_W_SnakeRows(path, fid)
    shotLister_E_SnakeCols_reverse(path, fid)
