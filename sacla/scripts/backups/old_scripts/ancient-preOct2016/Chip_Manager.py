...
def setdcparameters():
    ...
    #visit_id = '/dls/i24/data/2016/nt14493-9'
    visit_id = '/dls/i24/data/2016/nt14493-21'
...
def moveto(place):
    ...
    if place == 'zero':
        ...
        sleep(2)
        caput(pv.det_z, 1000)
        caput(pv.ap_pos, 'Manual Mounting')
        caput(pv.beamstop_rot, 186)
        sleep(2)
...
def cs_maker():
    ...
    fiducial_dict['f1']['x'] = 18.975 #14.575 
    fiducial_dict['f1']['y'] = 0 
    fiducial_dict['f1']['z'] = 0 

    fiducial_dict['f2']['x'] = 0 
    fiducial_dict['f2']['y'] = 21.375 #16.375
    ...
    cs1 = "#1->%+1.5fX%+1.5fY+0Z" % (-1*x1factor, y1factor)
    cs2 = "#2->%+1.5fX%+1.5fY+0Z" % (-1*x2factor, y2factor)
