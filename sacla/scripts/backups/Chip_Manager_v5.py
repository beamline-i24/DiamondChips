...
def write_parameter_file():
    ...
    visit = '/dls/i24/data/2017/nt14493-65/'
    f.write('visit \t\t%s\n' %visit)
    print 'visit:', visit
...
def cs_maker():
    ...
    # X=0.000099871 , Y=0.000099965, Z=0.0001000 (mm/cts for MRES and ERES)
    scalex, scaley, scalez  = 10013.0, 10003.5, 10000.0
    ...
    |0 Sx  Cx| |-Sy  0 Cy| | 0   0 1|   |-CxSyCz+SxSz  CxSySz+SxCz  CxCy|
    """
    # This was the old pre-skew method
