...
import Chip_StartUp_v7_ADE as startup
import Chip_Mapping_v7_ADE as mapping

lg.basicConfig(format='%(asctime)s %(levelname)s:\t%(message)s',level=lg.DEBUG, filename='ADE.log')
##############################################
# MANAGER  MANAGER  MANAGER  MANAGER MANAGER # 
# This version last edited 07Dec2017 by DAS  #
# Prep for SACLA3                            #
##############################################
...
def moveto(place):
    ...
    if place == 'zero':
        ...
        lg.info('%s %s'%(name,place))
        #ADE
        caput(pv.me14e_stage_x, -17.0)  
        caput(pv.me14e_stage_y, 5.0)
        caput(pv.me14e_stage_z, 0.0)
        #SACLA4
        """
        caput(pv.me14e_filter, 20)
    ...
    elif place == 'end_of_ADE':
        caput(pv.me14e_stage_x, 0.0)  
        caput(pv.me14e_stage_y, -12.0)
        caput(pv.me14e_stage_z, 0.0)
        sleep(0.5)
...
def cs_maker():
    ...
    #SACLA4
    scalex, scaley, scalez  = 10009.9, 10002.0, 10000.0
